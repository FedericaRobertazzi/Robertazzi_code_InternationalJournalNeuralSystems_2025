...
class parameters():
    def __init__(self):
        ...
        #self.a0_D1_to_beta = [11.42, 1.81, 0.5]#etaD1,low condition
        self.a0_D2_to_s0 = [1.2, 0.67, 0.5] #reference condition
        #self.a0_D2_to_s0 = [1.05,3.5,0.5]#etaD2,high condition
        self.k_VTA_D1 = [1.44, 1]
        self.k_SNc_D2 = [1.44, 1] 
        self.serotonin_D1 =0.5#0.1#0.3#0.5#0.7#0.9
        self.serotonin_D2 =0.5#0.1#0.3#0.5#0.7#0.9
