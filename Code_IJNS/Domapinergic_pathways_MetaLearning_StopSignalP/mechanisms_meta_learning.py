...
def serotonin_to_dopamine(serotonin_D1,serotonin_D2, k_VTA_D1,k_SNc_D2):
    D1 = k_VTA_D1[0]*m.log(serotonin_D1 + k_VTA_D1[1],m.e)
    D2 = k_SNc_D2[0]*m.log(serotonin_D2 + k_SNc_D2[1],m.e)
    return D1,D2
