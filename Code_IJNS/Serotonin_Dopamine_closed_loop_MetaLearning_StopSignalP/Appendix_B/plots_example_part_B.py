...
# plt.scatter(beta_new_Stop_Signal_failure_test, entropy_vec_Stop_Signal_failure_test,color='red', label='Stop_Signal_failure_test')
# plt.scatter(beta_new_Stop_Signal_correct_test, entropy_vec_Stop_Signal_correct_test,color='purple',  label='Stop_Signal_correct_test')
# plt.xlabel('beta new test', size=17)
# plt.ylabel('entropy test', size=17)
# plt.legend()
# plt.ylim(0,1)
...
# plt.figure()
# plt.scatter(Sero.memory,DopaD1.memory,c='black',label='Sero/DopaD1 out')
# plt.legend()
# plt.xlabel('xlabel')
# plt.ylabel('ylabel')
# plt.xlim([0,1])
...
# plt.show()
# #plt.plot(SeroD2.memory,label='SeroD2')

# plt.figure()
# plt.scatter(Sero.memory,DopaD2.memory,c='black', label='Sero/DopaD2 out')
# plt.legend()
# plt.xlabel('xlabel')
# plt.ylabel('ylabel')
# plt.xlim([0,1])
...
# plt.figure()
# plt.scatter(DopaD1.memory,DopaD2.memory, label='DopaD1/DopaD2 out')
# plt.legend()
# plt.xlabel('xlabel')
# plt.ylabel('ylabel')
# plt.xlim([0,1])
...
# plt.figure()
# plt.plot(Sero.memory,'black', label='Sero out')
# plt.xlabel('xlabel')
# plt.ylabel('ylabel')
# plt.show()

# plt.figure()
# plt.plot(DopaD1.memory,'black', label='DopaD1 out')
# plt.xlabel('xlabel')
# plt.ylabel('ylabel')
# plt.show()

# plt.figure()
# plt.plot(DopaD2.memory,'black', label='DopaD2 out')
# plt.xlabel('xlabel')
# plt.ylabel('ylabel')
# plt.show()

# plt.figure()
# plt.plot(Sero.memory,'r',label='Sero out')
# plt.plot(DopaD1.memory,'b',label='DopaD1 out')
# plt.plot(DopaD2.memory,'g',label='DopaD2 out')
# plt.legend()
# plt.show()